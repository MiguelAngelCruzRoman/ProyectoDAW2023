        ...
        <div class="col-8">
            <form action="<?= base_url('/administrador/medicos/editarMedicoDireccion/' . $usersInfo->id); ?>" method="POST">
                ...
                <div class="mab-3" align="center">
                    ...
                    <input type="url" class="form-control" name="foto" id="foto" value="<?= $usersInfo->foto ?>" placeholder="Ejemplo: https://foto.png" required max_length="250">
                </div>
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="apellidoMaterno" id="apellidoMaterno" placeholder="Ejemplo: Roman" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="15" min_length="3"
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="correo" id="correo" value="<?= $users->correo ?>" placeholder="Ejemplo: correo@ejemplo.com" required pattern="[a-z0-9]{@-_.}+" max_length="100" min_length="3">
                </div>

                <div class="mab-3">
                    <label for="username" class="form-label">Nombre de usuario:</label>
                    <input type="text" class="form-control" name="username" id="username"  placeholder="Ejemplo: Dr.Juan" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s0-9]+{-_.}" max_length="50" min_length="1"
                        value="<?= $users->username ?>">
                </div>

                <div class="mab-3">
                    <label for="password" class="form-label">Contraseña:</label>
                    <input type="password" class="form-control" name="password" id="password" placeholder="Ejemplo: password2" required max_length="150" min_length="1"
