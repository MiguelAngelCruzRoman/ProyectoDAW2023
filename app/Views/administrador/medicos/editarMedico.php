        ...
        <div class="col-md-8">
            <div id="login-container" class="row justify-content-center">
                ...
                <form action="<?= base_url('/administrador/medicos/editarMedicoDireccion/' . $usersInfo->id); ?>"
                    method="POST">
                    <?= csrf_field() ?>
                    <h1 align="center" style="color: #fff">Editar Médico</h1>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="primerNombre" id="primerNombre"
                            ...
                            min_length="3" value="<?= $usersInfo->primerNombre ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="segundoNombre" id="segundoNombre"
                            ...
                            value="<?= $usersInfo->segundoNombre ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="apellidoPaterno" id="apellidoPaterno"
                            ...
                            min_length="3" value="<?= $usersInfo->apellidoPaterno ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="apellidoMaterno" id="apellidoMaterno"
                            ...
                            min_length="3" value="<?= $usersInfo->apellidoMaterno ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="telefono" id="telefono"
                            ...
                            min_length="10" value="<?= $usersInfo->telefono ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="username" id="username"
                            ...
                            max_length="50" min_length="1" value="<?= $users->username ?>" style="color: #000000">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="password" class="form-control" name="password" id="password"
                            ...
                            value="<?= $users->password ?>" style="color: #000000">
                    </div>
