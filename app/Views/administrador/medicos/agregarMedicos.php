                ...
                <form action="<?= base_url('/administrador/medicos/agregarMedicosDireccion'); ?>" method="POST">
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="primerNombre" id="primerNombre"
                            ...
                            value="<?= isset($_POST['primerNombre']) ? $_POST['primerNombre'] : '' ?>">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="segundoNombre" id="segundoNombre"
                            ...
                            min_length="3" style="color: #000000"
                            value="<?= isset($_POST['segundoNombre']) ? $_POST['segundoNombre'] : '' ?>">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="apellidoPaterno" id="apellidoPaterno"
                            ...
                            min_length="3" style="color: #000000"
                            value="<?= isset($_POST['apellidoPaterno']) ? $_POST['apellidoPaterno'] : '' ?>">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="text" class="form-control" name="apellidoMaterno" id="apellidoMaterno"
                            ...
                            min_length="3" style="color: #000000"
                            value="<?= isset($_POST['apellidoMaterno']) ? $_POST['apellidoMaterno'] : '' ?>">
                    </div>

                    <div class="mb-3">
                        <label for="genero" style="color: #fff">Sexo:</label>
                        <select name="genero" id="genero" class="form-control" required style="color: #000000">
                            <?= isset($_POST['genero']) && $_POST['genero'] == "M" ? '<option value="M">Masculino</option>' : '' ?>
                            <?= isset($_POST['genero']) && $_POST['genero'] == "F" ? '<option value="F">Femenino</option>' : '' ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="especialidad" id="especialidad" class="form-control" required
                            style="color: #000000">
                            <?= isset($_POST['especialidad']) ? '<option value="' . $_POST["especialidad"] . '">' . $_POST["especialidad"] . '</option>' : '' ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="diasLaborales" id="diasLaborales" class="form-control" required
                            style="color: #000000">
                            <?= isset($_POST['diasLaborales']) ? '<option value="' . $_POST["diasLaborales"] . '">' . $_POST["diasLaborales"] . '</option>' : '' ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="turno" id="turno" class="form-control" required style="color: #000000">
                            <option value="matutino">Turno matutino (8:00-16:00)</option>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="password" class="form-control" name="password" id="password"
                            ...
                            style="color: #000000" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>">
                    </div>
                    ...
                    <div class="mab-3">
                        ...
                        <input type="url" class="form-control" name="foto" id="foto"
                            ...
                            value="<?= isset($_POST['foto']) ? $_POST['foto'] : '' ?>">
                    </div>
