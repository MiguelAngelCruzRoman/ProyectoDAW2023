<div class="container">
    <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
            <form action="<?= base_url('/administrador/editarMedico/update');?>" method="POST">
            <?= csrf_field()?>
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="estado" id="estado" value="<?= $direccion[0]->estado?>">
                </div>

                <div class="mab-3">
                    <label for="municipio" class="form-label">Municipio:</label>
                    <input type="text" class="form-control" name="municipio" id="municipio" value="<?= $direccion[0]->municipio?>">
                </div>

                <div class="mab-3">
                    <label for="colonia" class="form-label">Colonia:</label>
                    <input type="text" class="form-control" name="colonia" id="colonia" value="<?= $direccion[0]->colonia?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="tipo" id="tipo" class="form-control">
                        <option value="<?= $direccion[0]->tipo?>"><?= $direccion[0]->tipo?></option>
