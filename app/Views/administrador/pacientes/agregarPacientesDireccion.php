        ...
        <div class="col-8">
            <form action="<?= base_url('/administrador/pacientes/agregarPacientes/insert'); ?>" method="POST">
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="municipio" id="municipio" placeholder="Ejemplo: Teziutlán" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="50" min_length="2">
                </div>

                <div class="mab-3">
                    <label for="colonia" class="form-label">Colonia:</label>
                    <input type="text" class="form-control" name="colonia" id="colonia" placeholder="Ejemplo: El Mirador" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="50" min_length="2">
                </div>

                <div class="mab-3">
                    <label for="calle" class="form-label">Calle:</label>
                    <input type="text" class="form-control" name="calle" id="calle" placeholder="Ejemplo: Sin Rumbo" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="50" min_length="2">
                </div>

                <div class="mab-3">
                    <label for="noExt" class="form-label">Número exterior:</label>
                    <input type="number" class="form-control" name="noExt" id="noExt" placeholder="Ejemplo: 15" required pattern="[0-9]" max_length="11" min_length="1">
                </div>

                <div class="mab-3">
                    <label for="noInt" class="form-label">Número interior:</label>
                    <input type="text" class="form-control" name="noInt" id="noInt" placeholder="Ejemplo: 6,8" pattern="[0-9]+" max_length="11" >
                </div>

                <div class="mab-3">
                    <label for="CP" class="form-label">Código Postal:</label>
                    <input type="number" class="form-control" name="CP" id="CP" placeholder="Ejemplo: 73950" required pattern="[0-9]+" max_length="5">
                </div>
