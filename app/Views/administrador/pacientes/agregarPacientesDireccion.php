        ...
        <div class="col-8">
            <form action="<?= base_url('/administrador/pacientes/agregarPacientes/insert'); ?>" method="POST">
                ...
                <div class="mab-3">
                    ...
                    <input type="number" class="form-control" name="noExt" id="noExt" placeholder="Ejemplo: 15" required
                ...
                <div class="mab-3">
                    ...
                    <input type="number" class="form-control" name="CP" id="CP" placeholder="Ejemplo: 73950" required
