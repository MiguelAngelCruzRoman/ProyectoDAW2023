            ...
            <form action="<?= base_url('/administrador/pacientes/agregarPacientesDatosMedicos'); ?>" method="post">
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="segundoNombre" id="segundoNombre"
                        placeholder="Ejemplo: Ángel" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="15" style="color: #000000">
                </div>
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="telefono" id="telefono"
                        placeholder="Ejemplo: XXX-XXX-XXXX" pattern="[0-9]{-}" max_lengh="15" required min_length="10" style="color: #000000">
                </div>
                ...
                <div class="mab-3">
                    ...
                    <input type="email" class="form-control" name="correo" id="correo"
                        placeholder="Ejemplo: ejemplo@correo.com" required pattern="[a-z0-9]{@-_.}+" max_length="100"
                        min_length="7" style="color: #000000">
                </div>
                ...
                <div class="mab-3">
                    ...
                    <input type="password" class="form-control" name="contraseña" id="contraseña"
                        placeholder="Ejemplo: Contraseña1" required max_length="30" min_length="3" style="color: #000000">
                </div>
