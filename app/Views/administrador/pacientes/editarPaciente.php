        ...
        <div class="col-8">
            <form action="<?= base_url('index.php/administrador/pacientes/editarPacienteDatosMedicos/' . $paciente->id); ?>" method="post">
                ...
                <div class="mab-3" align="center">
                    ...
                    <input type="url" class="form-control" name="foto" id="foto" value="<?= $usersInfo[0]->foto ?>" placeholder="Ejemplo: https://foto.png" required  max_length="250" >
                </div>
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Ejemplo: XXX-XXX-XXXX" required pattern="[0-9]{-}" max_length="15" min_length="10"
                        value="<?= $usersInfo[0]->telefono ?>">
                </div>

                <div class="mab-3">
                    <label for="CURP" class="form-label">CURP:</label>
                    <input type="text" class="form-control" name="CURP" id="CURP" value="<?= $paciente->CURP ?>" placeholder="Ejemplo: CURM030923HMCRMGA6" required pattern="[A-Z0-9]+" max_length="18" min_length="18">
                </div>

                <div class="mab-3">
                    <label for="correo" class="form-label">Correo electrónico:</label>
                    <input type="text" class="form-control" name="correo" id="correo" value="<?= $users[0]->correo ?>" placeholder="Ejemplo: correo@ejemplo.com" required pattern="[a-z0-9]{@-_.}+" max_length="100" min_length="3">
                </div>

                <div class="mab-3">
                    <label for="username" class="form-label">Nombre de usuario:</label>
                    <input type="text" class="form-control" name="username" id="username" value="<?= $users[0]->username ?>" placeholder="Ejemplo: Paciente" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s0-9]+{-_.}" max_length="50" min_length="1">
                </div>

                <div class="mab-3">
                    <label for="contraseña" class="form-label">Contraseña:</label>
                    <input type="text" class="form-control" name="contraseña" id="contraseña" placeholder="Ejemplo: password2" required max_length="150" min_length="1"
