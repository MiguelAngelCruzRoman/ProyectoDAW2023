                ...
                <div class="card">
                    <div class="card-body">
                        <?php if ($receta->fechaVencimiento == date('0000-00-00')): ?>
                            <h3> Aún no se realiza la consulta de esta receta. <br> Favor de contactar al médico responsable
                            </h3>

                            <?php foreach ($consultas as $consulta):
                                if ($consulta->id == $receta->consulta): ?>
                            ...
                            <p><strong>Médico: </strong>
                                <?php foreach ($medicosPaciente as $medicoPaciente):
                                    if ($medicoPaciente->id == $idMedicoPaciente): ?>
                                ...
                                if ($recetaMedicamento->receta == $receta->id): ?>
                                    <?php foreach ($medicamentos as $medicamento):
                                        if ($medicamento->id == $recetaMedicamento->medicamento): ?>
                                            <li><a href="<?= base_url('/paciente/medicamento/sabermasMedicamento/' . $medicamento->id); ?>"
                                                    style="color:rgba(0,0,0,1)">
