        ...
        <form action="<?= base_url('/medico/consultas/realizarConsulta/'.$consulta->id);?>" method="POST" >
            ...
            <input type="hidden" name="medico_paciente" value=<?= $medico_paciente ?>>
                ...
                <div class="mab-3">
                    ...
                    <input type="text" class="form-control" name="lugar" id="lugar" placeholder="Ejemplo: Consultorio A" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="15" min_length="3" value="<?= $consulta->lugar?>">
                </div>

                <div class="mb-3">
                    <label for="motivo">Motivo de consulta:</label>
                    <input type="text" class="form-control" name="motivo" id="motivo" placeholder="Ejemplo: Dolor de cabeza" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" max_length="250" value="<?= $consulta->motivo?>">
                </div>
